  ...
  Widget buildFormFiled() {
    return Column(
      ...
      children: [
        ...
        label == null ? const SizedBox() : SizedBox(height: AppSize.sH8),
        TextFormField(
          onTapOutside: (event) =>
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: const BorderSide(color: ColorManager.whiteColor),
            ),
            ...
            fillColor: fillColor ?? ColorManager.fieldColor,
